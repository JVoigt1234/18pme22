...
public:
    ...
    void generateDataset(QDateTime timestamp, double min, double max, int minStep, int count, bool sugarValue, bool randomSkip, QList<Measurement>& listOfMeasurements);
